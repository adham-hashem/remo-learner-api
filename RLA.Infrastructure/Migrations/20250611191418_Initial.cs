        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostedAt = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseDiscussions_Professors_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Professors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LectureTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_Assistants_AssistantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDiscussions_ProfessorId",
                table: "CourseDiscussions",
                column: "ProfessorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quizzes_TermId",
                table: "Quizzes",
                column: "TermId");

            migrationBuilder.CreateIndex(
                name: "IX_Sections_AssistantId",
                table: "Sections",
                column: "AssistantId");
